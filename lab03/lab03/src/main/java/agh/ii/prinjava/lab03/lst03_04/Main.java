...
public class Main {
    ...
    private static void demo1() {
        ...
        try {
            ...
            System.out.println("demo1: catch (ChEx1.java e)");
        } finally {
    ...
    private static void demo2() {
        ...
        try (Resource1 r1 = new Resource1()) {
            ...
            System.out.println("demo2: catch (ChEx1.java e)");
        }
    }
    ...
    private static void demo3() {
        ...
        try {
            ...
            System.out.println("demo3: catch (ChEx2.java e)");
        } finally {
    ...
    private static void demo4() {
        ...
        try (Resource2 r2 = new Resource2()) {
            ...
            System.out.println("demo4: catch (ChEx2.java e)");
        }
    }
    ...
    private static void demo5() {
        ...
        try (Resource1 r1 = new Resource1();
            ...
            System.out.println("demo5: catch (ChEx1.java | ChEx2.java e)");
        }
    }
    ...
    private static void demo6() {
        ...
        try (Resource1 r1 = new Resource1();
            ...
            System.out.println("demo6: catch (ChEx1.java | ChEx2.java e)");
        } finally {
